...
export const data = [
    {
        image: product1,
        titleTop: 'Blended to Perfection',
        titleBottom: 'Coffees & Teas',
    ...
    {
        image: product2,
        titleTop: 'Delicious Treats, Good Eats',
        titleBottom: 'Bakery & Kitchen',
    ...
    {
        image: product3,
        titleTop: 'From Around the World',
        titleBottom: 'Bulk Speciality Blends',
