                ...
                <div className="container">
                    <div className="intro">
                        ...
                        <div className="intro-text left-0 text-center bg-faded p-5 rounded">
                            ...
                            <p className="mb-3">Every cup of our quality artisan coffee starts with locally sourced,
                            ...
                            <div className="intro-button mx-auto">
                                <a className="btn btn-primary btn-xl" href="#!">Visit
                                Us Today!</a></div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="col-xl-9 mx-auto">
                            <div className="cta-inner bg-faded text-center rounded">
                                ...
                                <p className="mb-0">When you walk into our shop to start your day, we are dedicated to
                                    ...
                                    satisfied, please let us know and we will do whatever we can to make things
                                    right!</p>
                            </div>
                        </div>
                    </div>
