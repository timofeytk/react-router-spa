    ...
    return (
        <div className='store'>
            ...
            <section className="page-section about-heading">
                <div className="container">
                    <img className="img-fluid rounded about-heading-img mb-3 mb-lg-0" src={image1}
                         alt="..."/>
                            ...
                            <div className="col-xl-9 col-lg-10 mx-auto">
                                <div className="bg-faded rounded p-5">
                                    ...
                                    <p>Founded in 1987 by the Hernandez brothers, our establishment has been serving up
                                        rich coffee sourced from artisan farmers in various regions of South and Central
                                        America. We are dedicated to travelling the world, finding the best coffee, and
                                    ...
                                    <p className="mb-0">
                                        ...
                                        sip. Join us for your daily routine, an outing with friends, or simply just to
